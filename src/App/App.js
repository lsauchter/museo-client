...
import { faPalette, faFlask, faBone, faLeaf, faHippo, faChild, faUniversity, faLandmark, faCheck, faLocationArrow, faTimes, faMonument, faGlobeAmericas, faCogs } from '@fortawesome/free-solid-svg-icons'
import './App.css'
...
function App() {
  ...
  library.add(faPalette, faFlask, faBone, faLeaf, faHippo, faChild, faUniversity, faLandmark, faCheck, faLocationArrow, faTimes, faMonument, faGlobeAmericas, faCogs)
