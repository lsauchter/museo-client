...
import { faPalette, faFlask, faBone, faLeaf, faHippo, faChild, faUniversity, faLandmark, faCheck, faLocationArrow } from '@fortawesome/free-solid-svg-icons'
...
function App() {
  ...
  library.add(faPalette, faFlask, faBone, faLeaf, faHippo, faChild, faUniversity, faLandmark, faCheck, faLocationArrow)
